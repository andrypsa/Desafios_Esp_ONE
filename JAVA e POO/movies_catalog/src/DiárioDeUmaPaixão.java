public class DiárioDeUmaPaixão {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(String.format("A nota média deste filme foi de %.1f", media));
        String sinopse = "texto";
        //Text block//
        System.out.println("A seguir leia a sinopse do filme:");
